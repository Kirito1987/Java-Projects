...
public class BenchmarkSorts {
    ...
    int[][] itListsToSort = new int[CYCLES][];
    int[][] recListsToSort = new int[CYCLES][];
    ...
    public BenchmarkSorts(int[] sizes) {
        sortSizes = sizes;
        iterativeCounts = new int[sizes.length][CYCLES];
        iterativeTimes = new long[sizes.length][CYCLES];
        recursiveCounts = new int[sizes.length][CYCLES];
        recursiveTimes = new long[sizes.length][CYCLES];
    }
